...
function Footer() {
  return (
    <footer data-aos="zoom-in" className="flex p-8 bg-stone-800 text-white justify-between items-center">
      ...
      <ul>
          ...
          <li className="hover:underline">Credit Card</li>
          <li className="hover:underline">Debit card</li>
        </ul>
      </div>
      <div className="space-y-4">
        ...
        <FaInstagram/>
        <FaFacebook/>
        <div className="flex items-center"><FaYoutube/>Youtube</div></div>
        <button className="flex gap-2 items-center bg-stone-900 px-2 py-1 text-white rounded-3xl">Buy raffle <MdArrowRightAlt size={24}/></button>
      </div>
    </footer>
  );
}
